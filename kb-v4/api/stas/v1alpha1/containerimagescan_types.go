...
// ContainerImageScanSpec defines the desired state of ContainerImageScan
type ContainerImageScanSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of ContainerImageScan. Edit containerimagescan_types.go to remove/update
